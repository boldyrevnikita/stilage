...
- `rack_types` -- список типов стеллажей, где:
    - `length`, `width`, `height_0`, `height_i`, `height_delta` -- длинна яруса, ширина (глубина) яруса, высота до первой балки стеллажа (включаю первую балку), высота между балками стеллажа (включаю верхнюю балку), высота опорных столбов над последним ярусом;
